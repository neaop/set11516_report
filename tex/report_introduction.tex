...
system - allowing a physical robot to map environment, calculate an optimal
route through said environment, and then execute the simulated movement.
...
such as the Roomba autonomous vacuum cleaner, or the Miimo robotic lawnmower
developed by Honda.
...
Further discussion of SLAM and SLAM solutions is provided in Section \editnote{REF HERE!}
...
discussed in Section \editnote{REF HERE!}
...
are discussed further in Section \editnote{REF HERE!}.
