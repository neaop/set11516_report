...
evaluation of a Simultaneous Localisation and Mapping solution utilising an
...
development platforms due to their low cost and availability.
...
it could be executed on device that would not impede the Thymio II's mobility,
potentially allowing the robot to simulate navigation of the mapped area.
While the study did not manage to achieve all the initially planned
