...
system - allowing a physical robot to map environment, calculate an optimal route
through said environment, and then execute the simulated movement.

The autonomous mapping of, and subsequent movement around unknown environments via
robotic agents has long been area of interest, and numerous implementations of
the concept are readily available in commercial products such as the Roomba
autonomous vacuum cleaner, or the Miimo robotic lawnmower developed by Honda.
...
to implement  mapping and navigation solutions, the financial and work costs of
such systems can often make them unfeasible.
...
This project explored and utilised a wide array of technologies and techniques to research,
